...
if(isset($_POST['priceLow']) && isset($_POST['priceHight'])){
    ...
    $query ="SELECT * FROM dienthoai WHERE Giadt BETWEEN $priceLow AND $priceHigh";
}
if(isset($_POST['brand']) && isset($_POST['priceLow']) && isset($_POST['priceHight'])){
    $brand = implode(",", $_POST["brand"]);
    $priceLow= $_POST['priceLow'];
    $priceHigh =  $_POST['priceHight'];    
    $query ="SELECT * FROM dienthoai WHERE ID_thuonghieu IN($brand) AND Giadt BETWEEN $priceLow AND $priceHigh";
}
...
if (isset($_POST["action"])) {
    $page_query = "SELECT * from dienthoai where ID_dienthoai = 12";
